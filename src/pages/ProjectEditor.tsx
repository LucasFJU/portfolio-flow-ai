    ...
    >
      ...
      <div className="absolute inset-0 bg-background/80 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
        <button
          {...attributes}
          {...listeners}
          className="p-2 rounded-md hover:bg-secondary cursor-grab active:cursor-grabbing"
        >
...
export default function ProjectEditor() {
  ...
  // Video validation
  const videoIsValid = project.videoUrl ? isValidVideoUrl(project.videoUrl) : true;
  const videoThumbnail = project.videoUrl ? getVideoThumbnail(project.videoUrl) : null;
    ...
    <Layout>
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          {/* Main Editor */}
          <div className={`flex-1 ${showPreview ? 'lg:max-w-2xl' : 'max-w-4xl mx-auto'}`}>
            {/* Header */}
                ...
                <CardContent className="space-y-4">
                  <div className="relative">
                    <Input
                      ...
                      className={project.videoUrl && !videoIsValid ? "border-destructive" : ""}
                    />
                    {project.videoUrl && (
              ...
              <div className="sticky top-24">
                <Card variant="glass" className="overflow-hidden">
                  ...
                  <CardContent className="p-0">
                    <div className="bg-background/50 p-6 min-h-[500px]">
                      {/* Preview Content */}
                      {project.images[0] && (
